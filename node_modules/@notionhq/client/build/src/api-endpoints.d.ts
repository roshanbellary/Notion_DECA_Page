 ...
 */
import { PaginatedList, PaginationParameters, Database, Page, ParentInput, PropertyValue, Block, BlockBase, User, UserBase, Filter, Sort, SearchSort, SearchFilter, InputPropertyValue, Property, ParentPageInput, PropertySchema, RichTextInput, UpdateBlock, UpdatePropertySchema } from "./api-types";
...
export interface BlocksRetrieveParameters extends BlocksRetrievePathParameters, BlocksRetrieveQueryParameters, BlocksRetrieveBodyParameters {
}
export interface BlocksRetrieveResponse extends BlockBase {
}
export declare const blocksRetrieve: {
    readonly method: "get";
    readonly pathParams: readonly ["block_id"];
    readonly queryParams: readonly [];
    readonly bodyParams: readonly [];
    readonly path: (p: BlocksRetrievePathParameters) => string;
};
...
declare type BlocksUpdateBodyParameters = UpdateBlock;
export declare type BlocksUpdateParameters = BlocksUpdatePathParameters & BlocksUpdateQueryParameters & BlocksUpdateBodyParameters;
export interface BlocksUpdateResponse extends BlockBase {
}
export declare const blocksUpdate: {
    readonly method: "patch";
    readonly pathParams: readonly ["block_id"];
    readonly queryParams: readonly [];
    readonly bodyParams: readonly ["paragraph", "heading_1", "heading_2", "heading_3", "bulleted_list_item", "numbered_list_item", "toggle", "to_do"];
    readonly path: (p: BlocksUpdatePathParameters) => string;
};
...
export declare type InputPropertySchemaMap = {
...
export interface DatabasesCreateParameters extends DatabasesCreatePathParameters, DatabasesCreateQueryParameters, DatabasesCreateBodyParameters {
}
export interface DatabasesCreateResponse extends Database {
}
export declare const databasesCreate: {
    readonly method: "post";
    readonly pathParams: readonly [];
    readonly queryParams: readonly [];
    readonly bodyParams: readonly ["parent", "properties", "title"];
    readonly path: () => string;
};
...
export declare type UpdatePropertySchemaMap = {
...
export interface DatabasesUpdateParameters extends DatabasesUpdatePathParameters, DatabasesUpdateQueryParameters, DatabasesUpdateBodyParameters {
}
export interface DatabasesUpdateResponse extends Database {
}
export declare const databasesUpdate: {
    readonly method: "patch";
    readonly pathParams: readonly ["database_id"];
    readonly queryParams: readonly [];
    readonly bodyParams: readonly ["properties", "title"];
    readonly path: (d: DatabasesUpdatePathParameters) => string;
};
